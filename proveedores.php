...
function leerPagina() {
    ...
    const frases = ['Página de Proveedores. Hay ' + cards.length + ' proveedores registrados.'];
    cards.forEach((c,i) => {
    ...
    frases.push('Presiona Enter sobre un proveedor para ver su catálogo de productos.');
    frases.push('Fin.');
